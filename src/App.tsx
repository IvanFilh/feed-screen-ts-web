...
const posts = [
  {
      ...
      content: [
          ...
          {type: 'paragraph', content: 'Acabei de subir mais um projeto no meu GitHub. É um projeto em ReactJs⚛️ com Vite⚡, dá um confere por lá XD'},
...

  {
      ...
      content: [
          ...
          {type: 'paragraph', content: 'Tela em Figma criado... enviando agora para a produção'},
